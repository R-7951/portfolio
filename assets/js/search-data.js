      ...
      window.location.href = "/portfolio/";
          ...
          handler: () => {
            window.location.href = "/portfolio/cv/";
              ...
              section: "Dropdown",
              handler: () => {
                window.location.href = "/portfolio/misc/";
              },
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%63%70%74.%6D%61%63%70@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/cptmacp", "_blank");
        },
      },{
        id: 'social-keybase',
        title: 'Keybase',
        section: 'Socials',
        handler: () => {
          window.open("https://keybase.io/cpt.macp", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/rahulnegi1409", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0004-9292-4362", "_blank");
        },
      },{
        id: 'social-telegram',
        title: 'telegram',
        section: 'Socials',
        handler: () => {
          window.open("https://telegram.me/cptmac", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/cptmacpro", "_blank");
        },
      },{
      id: 'light-theme',
